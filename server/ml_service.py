...
def predict_workout():
    try:
        ...
        print(f"User data retrieved: weight={weight}, height={height}, age={age}, gender={gender}")
        ...
        if missing_fields:
            return jsonify({
                "error": f"Incomplete user profile. Missing: {', '.join(missing_fields)}. Please complete your profile first.",
